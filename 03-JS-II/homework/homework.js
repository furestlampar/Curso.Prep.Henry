...
function obtenerMayor(x, y) {
  ...
  // Tu código:
  var xmayor = x; var ymayor = y;
  if (x > y) { return xmayor; } else if (x < y) { return ymayor; } else if (x === y) { return (xmayor || ymayor); }
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  var resultado = [];
  for (var i = 0; i <= 10; i++) { resultado.push(6 * i);} {return resultado;}
}

function tieneTresDigitos(numero){
  //Leer un número entero y retornar true si tiene 3 dígitos. Caso contrario, retorna false.
  //Escribe tu código aquí
if (numero === Math.floor(numero) && ((numero > 99 && numero < 1000) || (numero < -99 && numero > -1000))) {return true;}
else {return false;}
}
...
function doWhile(numero) {
  ...
  var a = numero;
  var i = 0; do { i = i + 1; a = a + 5;} while(i < 8); return a;
